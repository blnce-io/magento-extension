...
class Info extends \Magento\Payment\Block\Info
{
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        if ($this->appState->getAreaCode() === Area::AREA_ADMINHTML) {
            ...
            if (($transationId =
                $info->getAdditionalInformation(BalancepayMethod::BALANCEPAY_CHECKOUT_TRANSACTION_ID))) {
            ...
            $data[(string)__('Is Financed')] =
                (int) $info->getAdditionalInformation(BalancepayMethod::BALANCEPAY_IS_FINANCED) ?
                    __('Yes') : __('No');
        }
